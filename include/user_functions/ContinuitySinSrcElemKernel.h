...
#ifndef CONTINUITYSINSRCELEMKERNEL_H
#define CONTINUITYSINSRCELEMKERNEL_H
...
class ContinuitySinSrcElemKernel: public Kernel
{
public:
  ContinuitySinSrcElemKernel(
    const stk::mesh::BulkData&,
    SolutionOptions&,
    ElemDataRequests&);

  virtual ~ContinuitySinSrcElemKernel() {}
...
private:
  ContinuitySinSrcElemKernel() = delete;
...
#endif /* CONTINUITYSINSRCELEMKERNEL_H */
