...
#ifndef MOMENTUMSINSRCELEMKERNEL_H
#define MOMENTUMSINSRCELEMKERNEL_H
...
class MomentumSinSrcElemKernel: public Kernel
{
public:
  MomentumSinSrcElemKernel(
    const stk::mesh::BulkData&,
    const SolutionOptions&,
    ElemDataRequests&,
    bool lumped);

  virtual ~MomentumSinSrcElemKernel();
...
private:
  MomentumSinSrcElemKernel() = delete;
...
#endif /* MOMENTUMSINSRCELEMKERNEL_H */
